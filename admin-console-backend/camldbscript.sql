...
--
-- Table structure for table `trackingmethod`
--
DROP TABLE IF EXISTS `trackingmethod`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `trackingmethod` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(48) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_trackingmethod` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `trackingmethod`
--

LOCK TABLES `trackingmethod` WRITE;
/*!40000 ALTER TABLE `trackingmethod` DISABLE KEYS */;
INSERT INTO `trackingmethod` VALUES (1,'Normal',NULL),(2,'Attribute Based',NULL);
/*!40000 ALTER TABLE `trackingmethod` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `action` VALUES (1,'Action1',NULL,1,2);
...
CREATE TABLE `camera` (
  ...
  `trackingmethod` bigint DEFAULT NULL,
  `framewidth` double(10,2) DEFAULT '0.00',
  `hlsstreamurl` varchar(512) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `uk_camera_space` (`space`),
  KEY `uk_camera_status` (`status`),
  KEY `fk_camera_device` (`device`),
  KEY `fk_camera_trackingmethod` (`trackingmethod`),
  ...
  CONSTRAINT `fk_camera_trackingmethod` FOREIGN KEY (`trackingmethod`) REFERENCES `trackingmethod` (`id`)
...
--
-- Table structure for table `cameraregion`
--

DROP TABLE IF EXISTS `cameraregion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cameraregion` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `camera` bigint DEFAULT NULL,
  `x1` double(10,2) DEFAULT '0.00',
  `y1` double(10,2) DEFAULT '0.00',
  `x2` double(10,2) DEFAULT '0.00',
  `y2` double(10,2) DEFAULT '0.00',
  PRIMARY KEY (`id`),
  KEY `uk_cameraregion_camera` (`camera`),
  CONSTRAINT `fk_cameraregion_camera` FOREIGN KEY (`camera`) REFERENCES `camera` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=241 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cameraregion`
--

LOCK TABLES `cameraregion` WRITE;
/*!40000 ALTER TABLE `cameraregion` DISABLE KEYS */;
/*!40000 ALTER TABLE `cameraregion` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `camerastatus` VALUES (1,'Active',NULL),(2,'Inactive',NULL);
...
INSERT INTO `configobjectattribute` VALUES (1,'space_id',7,1,'Space'),(2,'max_density',7,1,'Maximum Density'),(3,'time_from',6,1,'Time From'),(4,'time_to',6,1,'Time To'),(5,'is_active',2,1,'Is Active'),(6,'space_id',7,2,'Space'),(7,'min_distance_in_ft',7,2,'Minimum Distance In feet'),(8,'max_seconds_before_alert',7,2,'Maximum Seconds Before Alert'),(9,'time_from',6,2,'Time From'),(10,'time_to',6,2,'Time To'),(11,'is_active',2,2,'Is Active'),(12,'space_id',7,3,'Space'),(13,'in_out_boundary',6,3,'In Out Boundary'),(14,'in_direction',6,3,'In Direction'),(15,'is_active',2,3,'Is Active');
...
INSERT INTO `devicestatus` VALUES (1,'Active',NULL),(2,'Inactive',NULL);
...
INSERT INTO `devicetype` VALUES (1,'caml',NULL);
...
CREATE TABLE `expression` (
  ...
  `rule` bigint DEFAULT NULL,
  `operations` bigint DEFAULT NULL,
  `configobject` bigint DEFAULT NULL,
  `attribute` bigint DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_expression_rule` (`rule`),
  KEY `fk_expression_operation` (`operations`),
  KEY `fk_expression_configobject` (`configobject`),
  KEY `fk_expression_attribute` (`attribute`),
  CONSTRAINT `fk_expression_attribute` FOREIGN KEY (`attribute`) REFERENCES `configobjectattribute` (`id`),
  CONSTRAINT `fk_expression_configobject` FOREIGN KEY (`configobject`) REFERENCES `configobject` (`id`),
  CONSTRAINT `fk_expression_operation` FOREIGN KEY (`operations`) REFERENCES `operations` (`id`),
  CONSTRAINT `fk_expression_rule` FOREIGN KEY (`rule`) REFERENCES `rule` (`id`)
...
INSERT INTO `expression` VALUES (1,'Expression1','1',1,1,1,1),(2,'Expression2','20',1,3,1,2);
...
INSERT INTO `operations` VALUES (1,'EQUAL TO','='),(2,'NOT EQUAL TO','!='),(3,'LESSER THAN','<'),(4,'GREATER THAN','>'),(5,'LESSER THAN OR EQUAL TO','<='),(6,'GREATER THAN OR EQUAL TO','>=');
...
-- INSERT INTO `rule` VALUES (1,'Rule1','Space equal to 1 and Maximum Density > 20',NULL,2,'2020-09-07 21:06:37',NULL);
...
INSERT INTO `ruleconfigobject` VALUES (1,1,1),(2,1,1);
...
INSERT INTO `rulestatus` VALUES (1,'Active',NULL),(2,'Inactive',NULL),(3,'Created',NULL);
...
--
-- Table structure for table `spacestatus`
--
DROP TABLE IF EXISTS `spacestatus`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `spacestatus` (
  ...
  `description` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_spacestatus_status` (`status`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `spacestatus`
--

LOCK TABLES `spacestatus` WRITE;
/*!40000 ALTER TABLE `spacestatus` DISABLE KEYS */;
INSERT INTO `spacestatus` VALUES (1,'Active',NULL),(2,'Inactive',NULL);
/*!40000 ALTER TABLE `spacestatus` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `space` (
  ...
  CONSTRAINT `fk_space_status` FOREIGN KEY (`status`) REFERENCES `spacestatus` (`id`)
...
INSERT INTO `spacetype` VALUES (1,'Building','Building Space'),(2,'Floor Space','Floor Space'),(3,'Enclosed Room','Enclosed Room');
...
INSERT INTO `state` VALUES (1,'North Carolina',1),(2,'New York',1),(3,'Texas',1),(4,'California',2);
...
-- Dump completed on 2020-09-07 21:56:04
